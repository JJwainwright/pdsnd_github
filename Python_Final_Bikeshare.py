...
def station_stats(df):
    ...
    print(most_common_start_station, "is the most commonly used start station." )

    # display most commonly used end station
    most_common_end_station = df["End Station"].value_counts().idxmax()
    print(most_common_end_station, "is the most commonly used end station.")

    # display most frequent combination of start station and end station trip
    most_common_start_end_station = df[["Start Station", "End Station"]].mode().loc[0]
    print("The most commonly used combinations of start and end stations is {} and {}."\
...
def user_stats(df):
    ...
    """Displays Statistics on bikeshare user's gender & birth year if available."""
...
if __name__ == "__main__":
>>>>>>> refactoring:Python Final - Bike Share.py
    main()